...
String sic=eutil.getdatafromexcel("org", 1, 8);
...
driver.findElement(By.id("siccode")).sendKeys(sic);
...
String actsic = driver.findElement(By.id("dtlview_SIC Code")).getText();
Assert.assertEquals(actsic.equals(sic), true,"Sic is not match");
Reporter.log("Siccode is match",true);
